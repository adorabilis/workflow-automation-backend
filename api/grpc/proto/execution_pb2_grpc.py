...
import api.grpc.proto.execution_pb2 as execution__pb2
...
class WorkflowExecutionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteWorkflow = channel.unary_unary(
                '/execution.WorkflowExecution/ExecuteWorkflow',
        ...
        self.GetWorkflowStatus = channel.unary_unary(
                '/execution.WorkflowExecution/GetWorkflowStatus',
                request_serializer=execution__pb2.GetWorkflowStatusRequest.SerializeToString,
                response_deserializer=execution__pb2.WorkflowStatusResponse.FromString,
                _registered_method=True)


class WorkflowExecutionServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_WorkflowExecutionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetWorkflowStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=execution__pb2.GetWorkflowStatusRequest.FromString,
                    response_serializer=execution__pb2.WorkflowStatusResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'execution.WorkflowExecution', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('execution.WorkflowExecution', rpc_method_handlers)
...
class WorkflowExecution(object):
    ...
    def GetWorkflowStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/execution.WorkflowExecution/GetWorkflowStatus',
            execution__pb2.GetWorkflowStatusRequest.SerializeToString,
            execution__pb2.WorkflowStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
